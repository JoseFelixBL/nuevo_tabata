...
import os                   # Para el manejo de los directorios
...
# Sonidos disponibles
final_s = sounds.Sound(os.path.join(data_dir, 'Final.wav'))
menos_tres_s = sounds.Sound(os.path.join(data_dir, 'En_3_2_1.wav'))
inicio_ej_s = sounds.Sound(os.path.join(data_dir, 'Inicio_ejercicio.wav'))
fin_ej_s = sounds.Sound(os.path.join(data_dir, 'Fin_ejercicio.wav'))
